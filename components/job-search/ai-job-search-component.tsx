    ...
    <div className="h-screen max-h-screen flex flex-col space-y-6 overflow-hidden">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Finde deinen Traumjob mit unserer KI-gestützten Suchfunktion
        </p>
      </div>
        ...
        <CardContent className="p-6">
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <Sparkles className="h-5 w-5 text-[#0F973D]" />
              <span className="text-sm font-medium text-[#0F973D]">KI-gestützte Suche</span>
            </div>
