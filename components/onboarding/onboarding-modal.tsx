...
export function OnboardingModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleModalClose}>
      <DialogContent className={`mx-auto p-0 rounded-2xl shadow-2xl border-3 border-[#0F973D] max-h-[80vh] ${currentStep === 3 ? 'max-w-4xl' : currentStep === 4 || currentStep === 5 || currentStep === 6 || currentStep === 7 || currentStep === 8 || currentStep === 9 ? 'max-w-4xl' : 'max-w-md'}`} showCloseButton={false}>
        <VisuallyHidden>
