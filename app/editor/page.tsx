...
export default function EditorPage() {
  ...
  const simpleEditorRef = useRef<any>(null);
  ...
  const logSimple = () => {
    if (simpleEditorRef.current) {
      console.log(simpleEditorRef.current.getContent());
    }
  };

  const saveSimpleContent = () => {
    if (simpleEditorRef.current) {
      const content = simpleEditorRef.current.getContent();
      console.log('Saving simple content:', content);
      alert('Simple content saved! Check console for details.');
    }
  };
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Please wait while the editor loads.</CardDescription>
            </CardHeader>
            <CardContent>
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>TinyMCE Editor Test (Full Featured)</CardTitle>
            <CardDescription>
              Test page for TinyMCE integration with Next.js
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Editor
              ...
              initialValue='<p>This is the initial content of the editor. You can start typing here to test the TinyMCE integration.</p>'
              init={{
                height: 500,
                menubar: true,
                plugins: [
            ...
            <div className="flex gap-4">
              <Button onClick={log} variant="outline">
        ...
        <Card>
          <CardHeader>
            <CardTitle>TinyMCE Editor (Simple Version)</CardTitle>
            <CardDescription>
              Simplified version without menubar, paragraph-only output with line breaks
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
               ...
               <Editor
                 ...
                 licenseKey='gpl'
                 onInit={(_evt, editor) => {
                   simpleEditorRef.current = editor;
                   updateWordCount(editor.getContent());
                 }}
                 onEditorChange={(content) => updateWordCount(content)}
                 initialValue='<p>Dies ist der erste Paragraph.</p><p>Dies ist der zweite Paragraph mit Zeilenumbruch.</p><p>Und hier ist der dritte Paragraph.</p>'
                                                             init={{
                 height: 300,
                 menubar: false,
                 statusbar: false,
             ...
             <div className="flex gap-4">
              <Button onClick={logSimple} variant="outline">
                Log Simple Content to Console
              </Button>
              <Button onClick={saveSimpleContent}>
                Save Simple Content
              </Button>
            </div>
          </CardContent>
